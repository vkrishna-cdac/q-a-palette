...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Procurement Q&A Review Console" },
      { name: "author", content: "Q&A Review Console" },
      { property: "og:title", content: "Procurement Q&A Review Console" },
      { property: "og:description", content: "Procurement Q&A Review Console" },
